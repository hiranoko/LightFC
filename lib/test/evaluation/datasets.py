...
dataset_dict = dict(
    ...
    tc128ce=DatasetInfo(
        module=pt % "tc128ce", class_name="TC128CEDataset", kwargs=dict()
    ),
    trackingnet=DatasetInfo(
        module=pt % "trackingnet", class_name="TrackingNetDataset", kwargs=dict()
    ),
    got10k_test=DatasetInfo(
        module=pt % "got10k", class_name="GOT10KDataset", kwargs=dict(split="test")
    ),
    got10k_val=DatasetInfo(
        module=pt % "got10k", class_name="GOT10KDataset", kwargs=dict(split="val")
    ),
    got10k_ltrval=DatasetInfo(
        module=pt % "got10k", class_name="GOT10KDataset", kwargs=dict(split="ltrval")
    ),
    lasot=DatasetInfo(module=pt % "lasot", class_name="LaSOTDataset", kwargs=dict()),
    lasot_lmdb=DatasetInfo(
        module=pt % "lasot_lmdb", class_name="LaSOTlmdbDataset", kwargs=dict()
    ),
    ...
    lasot_ext=DatasetInfo(
        module=pt % "lasot_ext", class_name="LaSOTExtDataset", kwargs=dict()
    ),
    uot=DatasetInfo(module=pt % "uot", class_name="UOTDataset", kwargs=dict()),
    uot_sim=DatasetInfo(
        module=pt % "uot", class_name="UOTDataset_SimSubset", kwargs=dict()
    ),
    uot_unsim=DatasetInfo(
        module=pt % "uot", class_name="UOTDataset_unSimSubset", kwargs=dict()
    ),
    ...
    utb_unsim=DatasetInfo(
        module=pt % "utb", class_name="UTBunSimDataset", kwargs=dict()
    ),
...
def load_dataset(name: str, env_num: int):
    ...
    dataset = getattr(m, dset_info.class_name)(
        **dset_info.kwargs
