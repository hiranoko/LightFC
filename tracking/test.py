...
def run_tracker(
    ...
    trackers = [
        Tracker(
            tracker_name, tracker_param, dataset_name, run_id, env_num, deploy=False
        )
    ]
...
def for_test():
    ...
    parser.add_argument(
        "--sequence", type=str, default=None, help="Sequence number or name."
    )
    ...
    tracker_list = [
        ...
        #  },
        {"name": "lightfc", "param": "baseline_v1_release_backbone_tinyvit"},
    ]
